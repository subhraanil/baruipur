...
export const metadata: Metadata = {
  ...
  title: {
    default: 'বারুইপুর অনলাইন - দক্ষিণ ২৪ পরগনার শীর্ষস্থানীয় আঞ্চলিক সংবাদ ও আপডেট',
    template: '%s | বারুইপুর অনলাইন'
  },
  ...
  creator: 'বারুইপুর অনলাইন (Baruipur Online)',
  publisher: 'বারুইপুর অনলাইন',
  alternates: {
  ...
  openGraph: {
    title: 'বারুইপুর অনলাইন - ২৪x৭ তাজা আঞ্চলিক খবর ও আপডেট',
    ...
    siteName: 'বারুইপুর অনলাইন (Baruipur Online)',
    locale: 'bn_IN',
    type: 'website',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'বারুইপুর অনলাইন - ২৪x৭ তাজা খবর',
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    alternateName: ['Baruipur News', 'Baruipur Online News', 'বারুইপুর খবর'],
    url: 'https://baruipur.online/',
